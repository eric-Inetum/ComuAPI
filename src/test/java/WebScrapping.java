...
public class WebScrapping {
  ...
  private static WebScrapping home_instance = null;

  // Instanciar clases de test con patrón Singleton
  public static WebScrapping setInstance() {
    if (home_instance == null) {
      home_instance = new WebScrapping();
    }
  ...
  public void Login_TC01() throws InterruptedException {
    ...
    // Assert.assertTrue(driver.findElements(By.xpath("//li[@id='item-0']/span[contains(text(),'Text
    // Box')]")).size() > 0);
    Thread.sleep(2000);
    ...
    driver.findElement(By.xpath("//input[@id='input-login']")).sendKeys("scrapping"); ////////////////////////// CAMBIAR
                                                                                      ////////////////////////// USUARIO
                                                                                      ////////////////////////// EN
                                                                                      ////////////////////////// SEPTIEMBRE

    driver.findElement(By.xpath("//input[@id='input-pass']")).sendKeys("Dbky1612@"); //////////////////////// CAMBIAR
                                                                                     //////////////////////// CONTRASEÑA
                                                                                     //////////////////////// EN
                                                                                     //////////////////////// SEPTIEMBRE
  ...
  // Automatización que recogera las URL de todos los jugadores del mercado para
  // sacar a traves de ella el nombre y

  // id para despues pasarlos a un fichero de texto que utilizaremos para otro
  // programa de web_scrapping

  public void GetNameAndIdPlayers_TC05() throws InterruptedException, IOException {

    WebDriverWait wait = new WebDriverWait(driver, 10);

    FileWriter fichero = new FileWriter(new File("web_scrapping/input/urls.txt"), true);
    ...
    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/section/div[3]/div[3]")));
    ...
    for (int i = 0; i < lengthPaginasInt; i++) {
      ...
      urlPlayer = wait
          .until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[@class='texto_pequenio2']/a")));
  ...
  public void GetNameAndOwner_11_TC06() throws InterruptedException, IOException {
    ...
    FileWriter fichero = new FileWriter(new File("web_scrapping/input/propietarios.txt"), true);
    ...
    if (driver.findElements(By.xpath("//button[@class=' css-qctjav']")).size() > 0) {
      driver.findElement(By.xpath("//button[@class=' css-qctjav']")).click();
    }
    ...
    driver.findElement(By.xpath("//*[@id='login']")).sendKeys("scrapping");

    driver.findElement(By.xpath("//*[@id='password']")).sendKeys("Dbky1612@");

    driver.findElement(By.xpath("/html/body/section/div[3]/div[2]/form/div[2]/button")).click();
    ...
    for (int a = 1; a != 18; a++) {
      try {
        if (driver.findElements(By.xpath("//*[@id='contenedor_comunidad']/div[2]/a[" + a + "]/div/div/span/strong"))
            .size() > 0) {
          participantes += 1;
        }
    ...
    for (int i = 1; i != (participantes + 1); i++) {
      try {
        String propietario = driver
            .findElement(By.xpath("//*[@id='contenedor_comunidad']/div[2]/a[" + i + "]/div/div/span/strong")).getText();
        WebElement propietarioRuta = driver
            .findElement(By.xpath("//*[@id='contenedor_comunidad']/div[2]/a[" + i + "]"));
        jsExecutor.executeScript("arguments[0].scrollIntoView();", propietarioRuta);
        propietarioRuta.click();
  ...
  /**
   * Automatixzación que recogera la ID y Oferta Minima de todos los jugadores del mercado del comunio
   * para despues pasarlo a un fichero de texto que se utilizara en otro programa de webscraping   
   */

  public void ofertaMinima() throws InterruptedException, IOException {
    WebDriverWait wait = new WebDriverWait(driver, 10);
    FileWriter fichero1 = new FileWriter(new File("web_scrapping/input/OfertaMinima.txt"), true);
  ...
  /**
   * Automatización que recogera el id del mejor fichaje del mercado de comunio 
   * despues se pasara a un fichero de texto que se utilizara en otro programa de  webscraping 
   */
  public void mejorFichaje() throws InterruptedException, IOException {
    WebDriverWait wait = new WebDriverWait(driver, 10);
    // Paso 1 -- Ir al comuniate 
    driver.get("https://www.comuniate.com/mercado.php");

    if (driver.findElements(By.xpath("//button[@class=' css-qctjav']")).size() > 0) {
      driver.findElement(By.xpath("//button[@class=' css-qctjav']")).click();
    }
    FileWriter fichero = new FileWriter(new File("web_scrapping/input/mejorFichaje.txt"),true);
    ...
    // cookies.click();
    // Paso 2 --  Pillar el ID del mejor fichaje del mercado 
  
    Thread.sleep(2000);
    WebElement usuari = driver.findElement(By.xpath("//*[@id=\"login\"]"));
    WebElement contrasenya = driver.findElement(By.xpath("//*[@id=\"password\"]"));
    usuari.clear();
    usuari.sendKeys("scrapping");
    contrasenya.clear();
    
    contrasenya.sendKeys("Dbky1612@");

    WebElement boton = driver.findElement(By.xpath("/html/body/section/div[3]/div[2]/div[1]/form/div[2]/button"));
    boton.click();

    Thread.sleep(10000);

    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='contenedor_comunidad']")));
    WebElement mejorFichaje = driver.findElement(By.cssSelector("#contenedor_comunidad > div:nth-child(2) > div > div.texto_pequenio2 > a"));
    ...
    // postcondicion
    // Este bloque de código ejecuta el Main.py para poder poder ejecutar el programa al momento 

      ProcessBuilder builder = new ProcessBuilder("cmd.exe", "/c", "C:/Users/pablo.castillo-mesa/AppData/Local/Programs/Python/Python311/python.exe C:\\Users\\pablo.castillo-mesa\\Desktop\\WebScrappingV1\\web_scrapping\\main.py");
